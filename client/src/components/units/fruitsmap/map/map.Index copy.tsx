...
import { MainContentWrapper, MapWrapper } from "./map.style";
              ...
              overlayContent.innerHTML = `
                  ...
                  ${
                    Array.isArray(position.imageurl) && position.imageurl[0]
                      ? `<img src="${position.imageurl[0]}" alt="가게 이미지" style="width: 20px; height: 20px;" />`
                      : `<img src="/images/fruit.png" alt="가게 이미지" style="width: 20px; height: 20px;" />
                ...
                <a href=${
                  position.link
                } target="_blank"  style="font-size: 16px; font-weight: bold; text-decoration-line: none">
                ${position.name}
               </a>
                </div>
